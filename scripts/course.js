...
courseCard(courses);
function courseCard(filterCourses) {
    const coursesC = document.querySelector('.courses');
    const totalCredits = document.querySelector('.tcredits');
...
const courseButton = document.querySelector('.all');
courseButton.addEventListener('click', () => {
    courseCard(courses);
});
const wddButton = document.querySelector('.wdd');
wddButton.addEventListener('click', () => {
    courseCard(courses.filter(wdd => wdd.subject === 'WDD'));
});
